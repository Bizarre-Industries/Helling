...
// ToInstance converts an Incus instance into our public shape. Status casing is
// normalized to lowercase to match the OpenAPI enum.
func ToInstance(in *Instance) Instance {
	if in == nil {
		return Instance{}
	}
	out := Instance{

...
| 010 | noVNC as primary VM browser console, SPICE fallback   | Accepted              |
...
| 015 | Native upstream responses                             | Accepted              |
| 016 | Helling CLI for Helling features only                 | Accepted              |
| 017 | systemd timers over cron                              | Accepted              |
| 018 | Shell out over libraries                              | Accepted              |
| 019 | Journal over SQLite audit                             | Accepted              |
| 020 | Incus config keys over SQLite tags                    | Accepted              |
...
| 033 | k3s via cloud-init for v0.1 provisioning              | Accepted              |

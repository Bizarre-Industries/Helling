...
IPMI/Redfish management via bmclib (ADR-014, optional build tag).
...
See docs/spec/architecture.md for the full upgrade sequence.
...
Checks: Incus socket reachable, Podman socket reachable, disk space, memory, systemd services running, certificate expiry.
